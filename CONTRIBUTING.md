...
[wiki](https://github.com/dvbern/cdi-persistence/wiki), then
[search the issue tracker](https://github.com/dvbern/cdi-persistence/issues)
to see if someone else in the community has already created a ticket regarding your issue.
If not, feel free to go ahead and [make one](https://github.com/dvbern/cdi-persistence/issues/new)!

### 2. Did you find a bug?

* **Ensure the bug was not already reported** by searching on GitHub under 
[Issues](https://github.com/dvbern/cdi-persistence/issues).

* If you're unable to find an open issue addressing the problem, 
[open a new one](https://github.com/dvbern/cdi-persistence/issues/new). 
...
[fork cdi-persistence](https://help.github.com/articles/fork-a-repo)
...
```sh
git remote add upstream git@github.com/dvbern/cdi-persistence.git
git checkout master
